...
export function MobileAccountPage({ profile, setProfile, addresses, setAddresses, setIsAuthenticated }) {
  // Profile modal
    ...
    <div className="min-h-screen pb-32 bg-background">
      <main className="pt-24 px-6 max-w-md mx-auto">
        ...
        <nav className="space-y-1">
          ...
          <Link className="group flex items-center justify-between p-5 bg-white border border-outline-variant/10 rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-slate-900/5 active:scale-[0.98]" to="/account">
            <div className="flex items-center gap-5">
              <div className="w-10 h-10 rounded-lg bg-surface-container flex items-center justify-center text-primary transition-colors group-hover:bg-primary-container group-hover:text-white">
