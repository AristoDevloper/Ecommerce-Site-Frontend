            ...
            <main className="pt-0">
                ...
                <section className="relative h-[921px] w-full flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-center px-6 max-w-4xl">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 justify-center">
                            <button className="bg-primary text-on-primary px-10 py-4 rounded-lg font-medium manrope-caps hover:scale-[1.02] transition-transform shadow-xl">Shop The Collection</button>
                            <button className="glass-nav text-primary px-10 py-4 rounded-lg font-medium manrope-caps hover:bg-white transition-colors">View Lookbook</button>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
                    <div className="flex justify-between items-end mb-16">
                        ...
                        <a className="manrope-caps text-xs font-bold text-primary border-b border-primary/20 hover:border-primary transition-colors pb-1" href="#">Explore All</a>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[800px]">
                        ...
                        <div className="md:col-span-4 group relative overflow-hidden rounded-xl bg-surface-container-low shadow-sm">
                            ...
                            <div className="absolute inset-0 bg-primary/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                                <button className="bg-white text-primary px-8 py-3 manrope-caps text-xs font-bold rounded shadow-lg">View Details</button>
                            </div>
                        </div>
                        {/*  Small Items  */}
                        ...
                        <div className="md:col-span-8 flex flex-col justify-center items-start p-12 bg-surface-container-high rounded-xl">
                            ...
                            <button className="text-primary border border-primary px-8 py-3 manrope-caps text-xs font-bold hover:bg-primary hover:text-white transition-colors">Discover Series</button>
                        </div>
                    </div>
                </section>
